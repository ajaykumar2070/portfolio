  ...
  return (
    <section className="grid grid-cols-2 mt-8 gap-6">
      {stats.map((stat) => {
        ...
        return (
          <Card key={stat.label} className="group relative transition-all duration-300 p-6 gap-4 overflow-hidden">
            ...
            <CardContent className="relative flex p-0 flex-col gap-1">
              <h3 className="font-bold text-white text-6xl leading-16 tracking-tight">
                {stat.value}
              </h3>
