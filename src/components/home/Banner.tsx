...
export default function Banner() {
    return (
        <div className="relative w-full md:h-160 py-10 md:py-0 overflow-hidden md:rounded-l-4xl">
            <img
                alt="Backdrop"
            ...
            <div className="relative flex px-6 md:px-12 flex-col justify-center h-full">
                <p className="text-primary font-serif italic text-4xl leading-9 font-medium">
                    FullStack Developer
                </p>
                ...
                <h1 className="max-w-xl font-bold text-neutral-50 text-5xl md:text-6xl leading-13 md:leading-15 mt-4">
